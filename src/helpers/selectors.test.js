...
const state = {
  ...
  appointments: {
    ...
    6: {
      id: 6,
      time: "5pm",
      interview: { student: "student1", interviewer: 3 },
    },
    7: {
      id: 7,
      time: "6pm",
      interview: { student: "student2", interviewer: 4 },
    },
    8: {
      id: 8,
      time: "7pm",
      interview: { student: "student3", interviewer: 5 },
    },
    9: {
      id: 9,
      time: "7pm",
      interview: { student: "student2", interviewer: 5 },
    }
  },
  interviewers: {
    "1": {  
...
test("getInterviewersForDay returns an array containing the correct interviewer objects", () => {
  const [first, second, third] = getInterviewersForDay(state, "Wednesday");
